...
def attack(char_name: str, char_class: str) -> str:
    """Вычисляем урон для разных классов."""
...
def defence(char_name: str, char_class: str) -> str:
    """Вычисляем защиту для разных классов."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    ...
    if char_class == 'healer':
        return (f'{char_name} применил специальное умение «Защита '
                f'{10 + 30}»')
    return (f'{char_name} не примернил специальное умение')


def start_training(char_name: str, char_class: str) -> str:
    """Начало тренировки. выбор действий attack/defence/special."""
    if char_class == 'warrior':
...
def main():
    """Начало. Приветствие, указание имени."""
